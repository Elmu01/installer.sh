...
sudo pacman -S amdgpu-pro-installer git zsh os-prober btop bitwarden discord steam grub-customizer solaar lutris plank gnome-boxes signal-desktop noto-fonts-emoji ksysguard flatpak starship --noconfirm --needed
