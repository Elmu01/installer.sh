...
yay -S brave-bin noisetorch-bin authy nvtop-git plank plex-desktop qdirstat bleachbit-git appimagelauncher-git gnome-boxes-git signal-desktop heroic-games-launcher-bin mullvad-vpn-bin cava piavpn-bin noto-fonts-emoji --noconfirm --needed
