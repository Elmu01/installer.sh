...
yay -S spotify authy qdirstat appimagelauncher heroic-games-launcher plex-desktop latte-dock-git mangohud lib32-mangohud ttf-firacode-nerd --noconfirm --needed
