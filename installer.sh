...
yay -S neofetch micro spotify authy qdirstat appimagelauncher heroic-games-launcher plex-desktop onedriver latte-dock-git mangohud lib32-mangohud ttf-firacode-nerd --noconfirm --needed
